import { GenerateRandomString } from "src/core/infra-base/generateId/generate-random-string";
...
export function generatePrefixId(
  ...
  const idGenerator = new GenerateRandomString(length);
  return `${prefix}_${idGenerator.generateId()}`;
}
